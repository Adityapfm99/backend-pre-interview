...
if __name__ == "__main__":
	...
	board = solve(SudokuBoard(boards.grid_01))	
	board2 = solve(SudokuBoard(boards.grid_02))
	board3 = solve(SudokuBoard(boards.grid_03))
	board4 = solve(SudokuBoard(boards.grid_04))
	board5 = solve(SudokuBoard(boards.grid_05))
	board6 = solve(SudokuBoard(boards.grid_06))
	board7 = solve(SudokuBoard(boards.grid_07))
	print "============Grid 1 Done!===========" if board else "Grid 1 Failed!"
	print board
	board2 = solve(SudokuBoard(boards.grid_02))
	print board2
	print "============Grid 2 Done!===========" if board else "Grid 2 Failed!"
	board3 = solve(SudokuBoard(boards.grid_03))
	print board3
	print "============Grid 3 Done!===========" if board else "Grid 3 Failed!"
	board4 = solve(SudokuBoard(boards.grid_04))
	print board4
	print "============Grid 4 Done!===========" if board else "Grid 4 Failed!"
	board5 = solve(SudokuBoard(boards.grid_05))
	print board5
	print "============Grid 5 Done!===========" if board else "Grid 5 Failed!"
	board6 = solve(SudokuBoard(boards.grid_06))
	print board6
	print "============Grid 6 Done!===========" if board else "Grid 6 Failed!"
	board7 = solve(SudokuBoard(boards.grid_07))
	print board7
	print "============Grid 7 Done!===========" if board else "Grid 7 Failed!"
